...
@bstolte_rides = Ride.create([
				...
				{ request: 'have_a_ride',
					...
					center: 'POINT(-122.420654 37.755312)'
				}])
...
@keithnorm_rides = Ride.create([
				{ request: 'need_a_ride',
					...
					center: 'POINT(-122.082653 37.390891)'
				},
				{ request: 'need_a_ride',
					...
					center: 'POINT(-122.083683 37.432205)'
				},
				{ request: 'need_a_ride',
					...
					center: 'POINT(-122.179298 37.455919)'
				}])
...
@mloseke_rides = Ride.create([
				{ request: 'need_a_ride',
					...
					center: 'POINT(-87.700424 41.908154)'
				},
				{ request: 'need_a_ride',
					...
					center: 'POINT(-87.697334 41.922684)'
				},
				{ request: 'need_a_ride',
					...
					center: 'POINT(-87.701240 41.915819)'
				}])
