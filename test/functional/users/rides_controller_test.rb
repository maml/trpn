...
class Users::RidesControllerTest < ActionController::TestCase
	...
	test "should create ride" do
		assert_difference('Ride.count') do
			post :create, ride: { description: @ride.description, latitude: @ride.latitude, longitude: @ride.longitude, request: @ride.request, title: @ride.title, from: @ride.from, to: @ride.to }, user_id: @user.id
		end
